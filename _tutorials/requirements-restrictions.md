...
This script is the defacto way to enable use of HTML5 sectioning elements in legacy Internet Explorer. For more info [view the our forked repository on GitHub](https://github.com/createdotnet/html5shiv).
